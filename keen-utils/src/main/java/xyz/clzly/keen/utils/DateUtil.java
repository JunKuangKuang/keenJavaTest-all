...
public class DateUtil {
    ...
    public static final String DATE_FORMAT_STRING = "EEE MMM dd HH:mm:ss zzz yyyy";
    // Dec 28, 2021 2:57:06 PM
    public static final String DATE_FORMAT2 = "MMM dd, yyyy h:mm:ss a";
    ...
    public static String formatEndDate(String string, String format) throws ParseException {
        ...
        if (date != null) {
            result = new SimpleDateFormat("yyyy-MM-dd").format(date) + " 23:59:59";
        }
        return result;
    }
    ...
    public static boolean checkDateFormat(String date, String format) {
        ...
        // Preconditions.checkArgument(, "日期为空");
        // Preconditions.checkArgument(StringUtils.isNotBlank(format), "日期格式为空");
    ...
    public static Date parseDateByString(String dateStr) {
        ...
        Date result = null;
        List<String> dateFormatList = Arrays.asList(FORMAT_DEFALUT, DATETIME_FORMAT, DATE_FORMAT, DATE_FORMAT_STRING, DATE_FORMAT2);
        ...
        if (result == null && dateStr.matches("[0-9]{13}")) {
            result = new Date();
            result.setTime(Long.valueOf(dateStr));
        }
        return result;
    }
}